...
Markdown denemeleriniz için [bir çevirmen](https://dillinger.io/) yararlı olacak
...
* https://guides.github.com  and  https://try.github.io
* build5nines.com/introduction-to-git-version-control-workflow/
